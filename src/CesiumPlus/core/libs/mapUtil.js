...
export const mapUtil = {
  ...
  async getHeightAtPoint(LngLat) {
    ...
    //console.log("this.viewer.terrainProvider", this.viewer.terrainProvider);
   ...
   * @returns
   */
  positionsArrToLngLatHeightArr(positions) {
    var lngLatHeightArr = [];
  ...
  setAttributeForEntity(entity, option, type) {
    ...
    if (type == "polyline") {
      ...
      let FFCoordinates = this.positionsArrToLngLatHeightArr(positionsTemp);
